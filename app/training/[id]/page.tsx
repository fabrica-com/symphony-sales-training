...
import { TrainingResults } from "@/components/training-results" // Import TrainingResults component
...
export default async function TrainingPage({ params }: TrainingPageProps) {
  ...
  // Debug logs
  console.log("[v0] Training Page - Training ID:", training.id)
  console.log("[v0] Training Page - Training Title:", training.title)
          ...
          <div className="mx-auto max-w-4xl px-4">
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                {training.subtitle && <p className="mt-2 text-lg text-muted-foreground">{training.subtitle}</p>}
                ...
                {detail ? (
                  <>
                    ...
                    <Card>
                      ...
                      <CardContent>
                        <p className="text-muted-foreground leading-relaxed">{detail.purpose}</p>
                        <div className="mt-4 rounded-lg bg-primary/5 border border-primary/20 p-4">
                          ...
                          <p className="mt-1 text-foreground">{detail.goal}</p>
                        </div>
                      </CardContent>
                    </Card>
                      ...
                      <Card className="bg-secondary/30 border-secondary">
                        <CardContent className="pt-6">
                          <div className="flex gap-4">
                            ...
                            <div>
                              <p className="text-lg italic text-foreground leading-relaxed">"{detail.quote.text}"</p>
                              <p className="mt-2 text-sm text-muted-foreground">— {detail.quote.author}</p>
                            </div>
                          </div>
                        </CardContent>
                      </Card>
